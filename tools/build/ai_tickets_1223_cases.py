...
META = dict(
    ...
    title='TAKRA AI — ใบงาน 1223–1230 UI Manual Test Cases',
    ...
    groups_label='8 กลุ่ม (1 กลุ่ม = 1 ใบงาน) · 5 ใบยังไม่มีหน้าจอ = เคสล่วงหน้า (⛔)',
    note=('🖥️ <b>Test target:</b> เว็บ <b>TAKRA AI</b> รุ่น UAT · ใช้ Chrome บนเดสก์ท็อป · บัญชี UAT ที่ต้องเตรียม: เจ้าของ workspace ที่ผูกบัญชี TikTok สำหรับส่งตรงไว้แล้ว · มีเสียง Google ในคลังเสียง · มีสินค้าและสคริปต์ที่อนุมัติแล้ว<br>'
          ...
          '⛔ <b>เคสล่วงหน้า (ยังไม่มีหน้าจอ):</b> '
          '<b>TAKRA-1223</b> เสียงกระดิ่ง — ยังไม่ groom · Expected ตามข้อเสนอในใบ (ตั้งค่าที่ "การแจ้งเตือน" · ค่าเริ่มต้นปิด) · '
          '<b>TAKRA-1226</b> takra-live บนเครื่อง remote — งาน infra · เคส smoke ผ่านหน้าเว็บหลังติดตั้ง · '
          '<b>TAKRA-1228</b> จัดหมวดคำเสี่ยงใหม่ — ยังไม่มีรายการหมวดใหม่ · เคส regression ก่อน/หลังย้ายหมวด · '
          '<b>TAKRA-1230</b> เสียงที่สองในไลฟ์ — spike · เคสเกณฑ์ขั้นต่ำเมื่อแตกเป็นตั๋ว dev ⇒ ปรับคำ/Expected เมื่อใบมี AC และหน้าจอจริง<br>'
