...
TICKETS = {
    ...
    't1223': ('notification-sound', 'เสียงกระดิ่งแจ้งเตือนในแพลตฟอร์มไลฟ์',
              'ยังไม่ groom · ยังไม่มีโค้ดเล่นเสียง (สวิตช์ "เสียงแจ้งเตือน" ใน "การตั้งค่าไลฟ์" มีแล้วแต่ยังไม่มีผล) → เคสล่วงหน้า (⛔) · '
              'ใบนี้คือกระดิ่ง <b>ของแพลตฟอร์มไลฟ์</b> ที่คนคุมไลฟ์ได้ยิน — คำอธิบายในใบชี้ไปกระดิ่งหน้า /home กับหน้า "ตั้งค่าบัญชี" ซึ่งไม่ใช่ · '
              'และไม่ใช่กระดิ่ง {{bell}} ในสคริปต์ (TAKRA-1215) ที่ผู้ชมได้ยิน · ข้อที่ยังรอเคาะ: ดังกับเหตุการณ์ไหน · ค่าเริ่มต้น · ระหว่างไลฟ์ต้องเงียบไหม', ''),
