...
TICKETS = {
    ...
    't1223': ('notification-sound', 'เสียงกระดิ่งเมื่อมีการแจ้งเตือนใหม่',
              'ยังไม่ groom · ยังไม่มีโค้ด → Expected ตามข้อเสนอในใบ (ตั้งค่าที่ "การแจ้งเตือน" · ค่าเริ่มต้นปิด) · เคสล่วงหน้า (⛔)', ''),
