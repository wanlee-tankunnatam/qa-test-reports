...
TICKETS = {
    ...
    't1223': ('notification-sound', 'เสียงกระดิ่งในไลฟ์เมื่อมีคอมเมนต์ใหม่ — ผู้ชมได้ยินด้วย',
              'groom แล้ว 24 ก.ย. 2569 (พร้อม dev) · ยังไม่มีโค้ด → เคสเขียนตาม AC1–AC8 ไว้ล่วงหน้า (⛔) · '
              'ของเดิมที่ใช้ต่อ: แท็ก {{bell}} (TAKRA-1215) + ชุดเสียง 10 แบบ (TAKRA-1269)',
              ' · ขอบเขต "กระดิ่งเมื่อมีออร์เดอร์ใหม่" ถูกตัดออกจากใบแล้ว'),
